...
@interface ZYSliderButton : UIButton

@end

@implementation ZYSliderButton
...
/** 滑块 */
@property (nonatomic, strong) ZYSliderButton *sliderBtn;
...
@implementation ZYPlayerSliderView
...
- (ZYSliderButton *)sliderBtn
{
    if (!_sliderBtn) {
        _sliderBtn = [ZYSliderButton buttonWithType:UIButtonTypeCustom];
