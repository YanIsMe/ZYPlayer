...
IJK_EXTERN NSString *const IJKMPMoviePlayerDidKeyFrameNotification;

IJK_EXTERN NSString *const IJKMPMoviePlayerDidBufferEnoughNotification;

IJK_EXTERN NSString *const IJKMPMoviePlayerDidPullStreamStateNotification;
IJK_EXTERN NSString *const IJKMPMoviePlayerDidPullStreamStateUserInfoKey;

IJK_EXTERN NSString *const IJKMPMoviePlayerDidKeyFrameNotification;

IJK_EXTERN NSString *const IJKMPMoviePlayerWarningNotification;
IJK_EXTERN NSString *const IJKMPMoviePlayerWarningUserInfoKey;

IJK_EXTERN NSString *const IJKMPMoviePlayerLoadTimeRanges;
@end
