...
@protocol ZYPlayerSliderViewDelegate <NSObject>
...
@interface ZYPlayerSliderView : UIView

@property (nonatomic, weak) id<ZYPlayerSliderViewDelegate> delegate;
